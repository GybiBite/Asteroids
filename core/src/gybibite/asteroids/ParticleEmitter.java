...
public class ParticleEmitter {
   ...
   * This object stores parameters for how to spawn the particles.
   *
   ...
   * @param spawnRange Range particles can spawn around spawn point.
   ...
   */
  ParticleEmitter(float size, Color color, float angleVar, float spawnRange, float lifetime,
      float lifeVar) {
    this.size = size;
    this.color = color;
   ...
   * @param lifeVar
   */
  ParticleEmitter(float size, Texture tex, float angleVar, float spawnRange, float lifetime,
      float lifeVar) {
    this.size = size;
    this.tex = tex;
    this.angleVar = angleVar;
  ...
  void emit(float x, float y, float angle, float speed) {
    ...
    GameUI.addParticle(new Particle(x + xOffset, y + yOffset, angle + angleOffset, speed,
        lifetime + lifeOffset, color, size));
  }
